function [config_exp] = exp_config(imagingFolderName)
    ...
    config_exp.time_date = '20250920';
    config_exp.time_hour = '201618';
    ...
    config_exp.experiment_pattern_times = repmat([5,15],1,9)*1;
    ...
    config_exp.imaging.message = ['Test to connect image acquisitions with automatic analysis (new out folder: .../CyGenTiG_AUTO/), final data in ../CyGenTiG_PROCESSING/'];
end
