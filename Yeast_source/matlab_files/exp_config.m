function [config_exp] = exp_config(imagingFolderName)
    ...
    config_exp.imaging.message = ['shorter patterns to test limitation, with new 3-D printed plate holder, add PFS function and specific capturing function for implementation, PFS enabled'];
