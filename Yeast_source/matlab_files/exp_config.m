function [config_exp] = exp_config(imagingFolderName)
    ...
    config_exp.time_date = '20250925';
    config_exp.time_hour = '112702';
    ...
    config_exp.imaging.message = ['Increasing and decreasing pattern, same as previous run, but switch back to original plate holder'];
end
