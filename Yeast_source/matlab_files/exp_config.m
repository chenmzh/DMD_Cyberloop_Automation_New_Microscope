function [config_exp] = exp_config(imagingFolderName)
    ...
    config_exp.experiment_pattern_times = repmat([5,15],1,7)*1;
    config_exp.experiment_pattern_values = repmat([1,0],1,7);
    ...
    config_exp.imaging.message = ['Testing telegram BOT'];
end
