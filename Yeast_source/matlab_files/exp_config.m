function [config_exp] = exp_config(imagingFolderName)
    ...
    config_exp.time_date = '20250930';
    config_exp.time_hour = '113910';
    ...
    config_exp.experiment_pattern_times = repmat([1200,60,120,60,240,60,480,60,920,60,1800,60,3200],1,1);	
    ...
    config_exp.imaging.message = ['Testing patterns with short bursts and ovelapping peaks, fast sampling 1 img/min'];
