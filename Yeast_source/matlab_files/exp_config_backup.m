function [config_exp] = exp_config(imagingFolderName) 
    ...
    config_exp.timestamp = '2025-09-17_05:00 PM'; 
    ...
    config_exp.experiment_pattern_times_cumulative = cumsum(experiment_pattern_times);
    config_exp.experiment_pattern_values = [0, 1, 0, 1, 0];
    config_exp.experiment_time_length = sum(experiment_pattern_times); % in seconds
